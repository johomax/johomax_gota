...
- Game structure on this engine (v175 ten-seat baseline, 240 games, tools/replay_lanes.py): winner's first gate attack median 3068 (unchanged) but first fort attack 10392 and game end 10614 — the two guards add ~7000 ticks of siege between gate and fort; mid is the breakthrough lane in 138/240; 4-5 winner heroes attack the fort in 159/240; heroes die 4.7-9.5 times and reach levels 6-11; a hero issues ~1300 hero-attack and ~1000 footman commands per game. Long games favour farmers/fighters (aaron-gota-ir-win-bounded 0.667 in that batch).
