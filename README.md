...
- **Portfolio (2026-09-18 00:50 UTC):** the field re-tunes against the live policy within hours; the matrix of our versions vs the current league labels (`xp_league.py homo`, `homo_report.py`) decides what is live. v218 (33/48) leads v186 (30/48); v186 beats the kites, v218 beats aaron-on-Blue, relh, richard and g002.
- **Two formats:** v218 is tuned for the league's 5v5 homogeneous rounds; for mixed-team (offline tournament) play use v212 (mixed bed 56/144; v209 51, v218 24 on identical rosters).
