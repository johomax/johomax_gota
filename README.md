...
- **07:35 UTC 2026-09-22: live policy v349** (= v338). The season league runs MIXED rosters: one hero of ours per game with nine other players' policies, and the round score is that hero's XP minus 200 per minute. v295-v306 seated slots 3-4 as guards (40% of our games scored 0); v312/v315 made every seat farm; v317 (farmer draft, no defence) 1048 hosted; v338 (+ damage/armour kit, outer/inner tower sieging with creeps, ranged heroes camp beside the enemy god from level 12 without health retreats) 1154 at n=269 in the ten-seat league-format test (`tools/xp_mixed.py`, `tmp/mixed_pool.py`). The leaders (relh v161, richard v153) average ~1700 in the same games with every class: they fight at mid from tick 600, take the mid towers by tick 1200-3600 with the wave, kill heroes (150 XP) and towers (100 XP), buy nine items, and camp the enemy spawn; a hero at ~900 XP/min does not need long games. Our attempts at that (v325-v328 camp early, v350 everyone mid) die; v352/v354 (opening brawl at mid) are under test. Hosted ten-seat batches swing by 600 between batches of one version: pool n>=200 before believing a difference. Ladder after round 629: relh 1468, richard 1116, khors 910, Jordan 852.
- **00:56 UTC 2026-09-22: live policy v304** (v300 00:37, v296 00:15 before it). Farmer line: v296 farmer-heavy draft + lane-tower flee + shadow guards, v298 Ranger/Berserker preference + one home guard, v300 keep-to-lane-tower portal restored, v301 both guards home, v302 farmers take enemy ranged creeps first, v304 that priority only for ranged heroes. Six-seed hosted means vs base v2 / g003 / khors: v300 1407, v301 1539, v302 1554; v304 equals v302 as Red and adds ~300 as Blue locally (hosted pending). Ladder after round 616: rank 2 at 316 (khors 373). Stopped 00:57 UTC; see docs/HANDOFF.md.
- **00:06 UTC 2026-09-22: live policy v295 — NEW GAME, NEW OBJECTIVE.** The league moved to coworld cow_e5445477 (2026.9.21.5) at ~22:30 UTC on 09-21 and the ladder was reset. Each hero's ladder score is now lifetime XP minus 200 per simulated minute (draft included), floored at zero, averaged over the team; victory is recorded separately and does not count. A lane's eight enemy creeps per wave give 360 XP/min shared within six tiles, so one hero per lane nets +160/min and two in a lane net nothing. v295 = the new baseline turned into three solo lane farmers (slots 0-2 on lanes 0/2/mid, following their own lane's wave front, holding six tiles off enemy towers, casting only above half mana) plus two home guards; nobody attacks buildings or the god. Hosted (n=2 x 9 labels): v295 1092 mean vs opponents 84 (v294 608, baseline 250ish). Old policies crash on the new BASIC (decimal division) and drafted nothing: v284 went 0/40.
- **21:19 UTC 2026-09-21: live policy v284** = v267 + the camped-lane switch (resistance >= 90) on both sides, and on Blue only the v212 guard group focus and the dagger before the boots. The field turned over during the 09-19/09-21 pause (relh v159 at 1925, richard v135 at 1777, Aaron's formation-profile pair, Alex Smith's codex hero-timing label); v268 went 52/107 (Red 16/56) and fell to rank 6 at 1620. Six seeds x ten field labels (xp/mx6-f0921-*.json): v284 79/120 — Blue 48/60 (loses only codex and richard), Red 31/60 (loses relh/richard/codex); v285 = v284 with Red lane 0 is the complement (Red beats relh 5/6, richard 6/6, codex 6/6, loses every race). Elo-weighted picker (`tmp/elo_pick.py`): v284 +1.67 Elo/game, v278 +1.03, v267 +0.75, v268 -1.10. v212's Blue beat relh/Aaron where v267's stood beside the dead gate without touching the guards.
- **22:34 UTC 2026-09-18: live policy v268** = v267 with Red opening on lane 2. Aaron's two accounts switched to relh154-legacy labels that camp mid; v268 beats them 12/12 on Red (v267 0/6) and the kites 12/12, at the cost of the straight Red races (relh/richard/nancy/g002/macromackie 0/12). Portfolio choice by the recent field mix (picker last five rounds 0.720 vs 0.633); v267 remains the mid alternate.
...
- **Two formats:** v228 is tuned for the league's 5v5 homogeneous rounds; for mixed-team (offline tournament) play use v212. Realistic mixed bed (us + four weak allies vs five top labels, 48 rosters x 3): v212 46/144 vs v228 31/144 on the black-kite v16 pool; v212 79/432 vs v267 77/432 over 144 rosters (blocks: 32-21, 24-25, 23-31; paired v212 better 21 / worse 25) — a dead heat, so v267 serves both formats; v268 72/432; v228 19/144, v254 20/144, v270 22/144 on block 1) on the 2026-09-18 pool (relh v154, red-kite v34, aaron coordinated-support-anchor in TOP).
