...
- Coworld: `cow_d7a245f0-a819-41b7-a56c-e05d4030ab5d` version 2026.9.14.2 (downloaded to `coworld/`).
...
P=policy/v1.bas; uv run coworld run-episode ./coworld/cow_d7a245f0-a819-41b7-a56c-e05d4030ab5d/coworld_manifest.json $P $P $P $P $P policy/base.bas policy/base.bas policy/base.bas policy/base.bas policy/base.bas -o runs/x
