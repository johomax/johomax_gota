...
- **Champion since 03:36 UTC 2026-09-16: v113 = `Jordan:v113`** = v93 + stutter-step kiting for ranged classes (hit while the attack
  ...
  farm radius 8 tiles) 63/57. Next: v122 (walk the lane's route points when the objective is far; the hero snags 6.3 times per game on
  long cross-map walks and occasionally stays stuck all game).
