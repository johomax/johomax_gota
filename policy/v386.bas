' v386 = v363 with every hero starting in lane 0 (the left/top edge lane); the mirror of v385
...
if initialized = 0 then
  initialized = 1
  ' v386: everyone starts in lane 0 (control for v385's lane 2: the two side lanes are mirror images)
  laneIdx = 0
  floater = 1
  lastLaneChange = 0
  switches = 0
