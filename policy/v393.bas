' v393 = v385 with the health retreat at 40% instead of 25%
...
' v393: retreat at two fifths HP instead of a quarter — a hunted carry at a quarter HP rarely escapes a bruiser
if selfHp * 5 < selfMaxHp * 2 and camp = 0 then
  retreating = 1
end if
