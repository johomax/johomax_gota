' v353 = v351 camping from level 10 (v346's single batch 1229 vs v338 1154)
' v351 = v348 + v345's camp point four tiles from the god (hosted: v345 1336, v348 1257, v338 1154)
...
if floater = 1 and worldTick >= 1200 and worldTick - lastLaneChange >= 2400 and worldTick mod 600 < 6 then
  ...
  if newLane <> laneIdx and curAllies >= 2 and frontAllies >= 2 and switches < 3 then
    laneIdx = newLane
...
camp = 0
if laneIdx <= 2 and selfLevel >= 10 and prevCampHeroes = 0 and attackRange >= 4 and selfDeaths < 5 then
  camp = 1
end if
