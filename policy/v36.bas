...
' v36 = v30 + rejoin re-armed every 480 ticks (an isolated hero joins the allied group).
...
' periodically re-arm the rejoin so an isolated hero goes where its allies are
if worldTick mod 480 = 0 and enemyHeroNear = 0 and towerId = 0 and fortId = 0 then
  rejoinArmed = 1
end if
