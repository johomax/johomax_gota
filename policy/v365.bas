' v365 = v363 + v362's nearest-enemy-wave lane choice (every 600 ticks; cost = wave distance from our god + distance from us + 6000 per allied hero in the region) and the fallback-goal fix
