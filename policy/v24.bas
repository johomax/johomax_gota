...
' v24 = v19 + death-context telemetry (DC line) and footman counts; behaviour identical.
...
if selfHp > prevHp + 150 then
  ...
  print "DC " ; dcTick ; " p " ; dcX ; " " ; dcY ; " oi " ; dcOi ; " act " ; dcAct ; " eh " ; dcEh ; " tw " ; dcTw ; " fa " ; dcFa ; " fe " ; dcFe ; " al " ; dcAl ; " L" ; dcLvl
end if
prevGold = selfGold
prevHp = selfHp
...
while i < n
  ...
  if t = selfTeam then
    if k = 3 then
      if objectAlive(i) = 1 and d2 <= 25 then
        footAlly5 = footAlly5 + 1
      end if
    end if
    if k = 2 then
...
if worldTick mod 480 = 0 then
  print "T " ; worldTick ; " p " ; selfX ; " " ; selfY ; " hp " ; selfHp ; "/" ; selfMaxHp ; " L" ; selfLevel ; " g" ; selfGold ; " oi " ; oi ; " act " ; act ; " eh " ; enemyHeroNear ; " al " ; allyCount ; " fa " ; footAlly5 ; " fe " ; footEnemy5 ; " tw " ; towerId
end if
