...
' regroup: never push into enemy territory alone; wait at the previous waypoint for at least two allies
if done = 0 and routing = 0 and oi >= 3 and allyCount < 2 and enemyHeroNear = 0 and fortId = 0 then
  dx = rx - selfX
  dy = ry - selfY
