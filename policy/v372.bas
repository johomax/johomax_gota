' v372 = v363 with Ranger/Crossbowman camping from level 8 (games now end near tick 18000; the level-12 -> 10 step measured +480 paired)
...
if laneIdx <= 2 and prevCampHeroes = 0 and selfDeaths < 4 then
  ...
  if selfLevel >= 8 and (selfClass = Ranger or selfClass = Crossbowman) then
    camp = 1
  end if
end if
