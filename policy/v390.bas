' v390 = v385 with the enemy-base camp disabled (farm lane 2 all game)
...
camp = 0
' v390: no camping at all — the camp's +480 was measured in the old field; the leaders now converge on the enemy base and hunt there
if laneIdx <= 2 and prevCampHeroes = 0 and selfDeaths < 4 and worldTick < 0 then
