' v391 = v385 + a second portal scroll bought after the boots (scrolls stack)
...
sub inventory()
  ...
  if laneIdx <= 2 then
    ' v391: two scrolls in the bag — lane 2's clash sits ~110 tiles from the keep by the edge path, so every return on foot costs 45 seconds
    buy(21, 100, 1)
    buy(1, 30, 1)
    buy(8, 100, 1)
    buy(21, 100, 2)
