' v406 = v385 with the camp point a sixth of the way from the enemy god to the centre (~8 tiles) instead of a ninth: bracket the other side
...
sub observe()
  ...
  prevFrontY = frontY
  frontAllies = 0
  campX = enemyX + (mapWidth \ 2 - enemyX) \ 6
  campY = enemyY + (mapHeight \ 2 - enemyY) \ 6
  bestScore = -10000
  frontD = 1000000
  nearCreeps = 0
  baseThreat = 0
