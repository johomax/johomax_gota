' v347 = v338 camping from tick 10000 at level 8 or more (hosted test)
...
camp = 0
if laneIdx <= 2 and worldTick >= 10000 and selfLevel >= 8 and prevCampHeroes = 0 and attackRange >= 4 then
  camp = 1
end if
