' v378 = v363 DEBUG BUILD: prints every visible enemy hero's level and items every 1200 ticks and our own gold/items (not for promotion)
...
sub readObject(index)
  ...
  if kind = 2 and worldTick mod 4800 < 6 then
    print "ITEMS " ; worldTick ; " id " ; id ; " L" ; objectLevel(index) ; " hp " ; hp ; " items " ; objectItemId(index, 0) ; "x" ; objectItemCount(index, 0) ; " " ; objectItemId(index, 1) ; "x" ; objectItemCount(index, 1) ; " " ; objectItemId(index, 2) ; "x" ; objectItemCount(index, 2) ; " " ; objectItemId(index, 3) ; "x" ; objectItemCount(index, 3) ; " " ; objectItemId(index, 4) ; "x" ; objectItemCount(index, 4) ; " " ; objectItemId(index, 5) ; "x" ; objectItemCount(index, 5)
  end if
...
if worldTick mod 4800 < 6 then
  print "SELF " ; worldTick ; " gold " ; selfGold ; " items " ; itemId(0) ; "x" ; itemCount(0) ; " " ; itemId(1) ; "x" ; itemCount(1) ; " " ; itemId(2) ; "x" ; itemCount(2) ; " " ; itemId(3) ; "x" ; itemCount(3) ; " " ; itemId(4) ; "x" ; itemCount(4) ; " " ; itemId(5) ; "x" ; itemCount(5)
end if
