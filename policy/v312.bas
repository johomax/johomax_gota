' v312 = v310 + floaters: slots 3-4 farm a lane whose region has no allied hero (every seat must score in mixed rosters), guard only when all three lanes are held
