' v383 = v363 + melee heroes never start in the mid lane (team 0 -> lane 0, team 1 -> lane 2)
...
if initialized = 0 then
  ...
  ' v383: melee heroes never start in mid (seats 4 and 9, the last picks, scored 109 and 167 with 74-81% zeros; the mid crowd eats them): team 0's melee take lane 0, team 1's lane 2
  if attackRange < 4 and laneIdx = 1 then
    laneIdx = 2 * selfTeam
  end if
  floater = 1
  lastLaneChange = 0
