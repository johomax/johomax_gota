' v392 = v385 + heroes fight back at an enemy hero attacking them from within three tiles (+400 target score)
...
sub readObject(index)
  ...
  elseif kind = 2 then
    ...
    ' v392: fight back — an enemy hero that is attacking us from within three tiles outranks any creep (our carries kept farming under a VK's blows until a quarter HP, then ran and died)
