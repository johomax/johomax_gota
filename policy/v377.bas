' v377 = v363 with a weapon-first shop list: Crimson Dagger, potion, scroll, Rune Crossbow, Battle Axe, boots, Knight Armor, potions
...
sub inventory()
  ...
  if laneIdx <= 2 then
    ' v377: weapon first. Heroes start with 150 gold and earn 15 per last hit; a Ranger hits for 25 at level 1, so a Crimson Dagger (+8) is +32%
    ' damage all game, while the scroll (100) was rebought on every keep visit and no weapon was ever bought (v375: delaying equipment cost 326 points)
    buy(11, 110, 1)
    buy(1, 30, 1)
    buy(21, 100, 1)
    buy(19, 180, 1)
