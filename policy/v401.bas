' v401 = v385 with the hunter flee limited to melee heroes (ranged non-carries no longer flee)
...
' v401: only melee heroes flee hunters; Arcanist, Lich and Warlock keep farming like the carries (a twenty-second flee cost ranged heroes 200 points in v400)
if worldTick < hunterUntil and camp = 0 and attackRange < 4 then
  fleeX = homeX
  fleeY = homeY
