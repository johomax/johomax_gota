' v396 = v385 + ranged heroes hold two tiles ahead of the leading allied creep (closer to where the enemy ranged creeps die)
...
if laneIdx <= 2 and frontD < 1000000 then
  goalX = frontX
  goalY = frontY
  ' v396: ranged farmers stand two tiles ahead of the leading allied creep: enemy ranged creeps die four tiles behind their melee line, outside a six-tile share from the old spot
