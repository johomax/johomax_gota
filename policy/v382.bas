' v382 = v363 + every ability is cast on cooldown whenever the mana is there (no half-mana gate, creeps included): regen is 240 mana a minute
...
sub spells()
  for spellSlot = 0 to 3
    ...
    if abilityLevel(spellSlot) > 0 and charges > 0 then
      ' v382: no mana gate at all — mana regenerates 1 per 6 ticks (240 a minute, a Ranger pool is 110), so idle mana is wasted; the leaders cast 1000-3000 times a game
