' v399 = v385 with the camp allowed until the sixth death instead of the fourth
...
camp = 0
' v399: the camp survives up to five deaths (the leaders keep camping through 5-8 buybacks; ours stops after three)
if laneIdx <= 2 and prevCampHeroes = 0 and selfDeaths < 6 then
