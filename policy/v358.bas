' v358 = v357 with melee heroes camping from level 12 as well (under the three-death guard; richard's melee heroes camp and average 1250-2500)
...
camp = 0
if laneIdx <= 2 and selfLevel >= 12 and prevCampHeroes = 0 and selfDeaths < 4 then
  camp = 1
end if
