' v379 = v363 with a damage kit and no boots: scroll, potion, Rune Crossbow, Battle Axe, Arcane Spellbook, Knight Armor, potions (item probe: 1560 gold sat idle with six full slots; leaders carry three weapons by tick 9600)
