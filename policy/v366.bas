' v366 = v363 with the hunter rule for every class (carries too flee ten seconds from an enemy hero two levels above them within twelve tiles)
...
if worldTick < hunterUntil and camp = 0 then
  fleeX = homeX
  fleeY = homeY
