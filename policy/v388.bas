' v388 = v385 with the FLOAT lane moves disabled (everyone stays in lane 2)
...
' v388: no lane moves at all — lane 2 beat lane 0 by 257 paired, so leaving it for a 'quieter' lane is a loss
